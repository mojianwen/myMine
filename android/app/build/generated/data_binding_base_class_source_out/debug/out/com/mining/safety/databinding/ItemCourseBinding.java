...
public final class ItemCourseBinding implements ViewBinding {
  ...
  private ItemCourseBinding(@NonNull CardView rootView, @NonNull TextView tvDescription,
      @NonNull TextView tvDuration, @NonNull TextView tvName, @NonNull TextView tvStatus,
      @NonNull TextView tvTrainer, @NonNull TextView tvType) {
  ...
  public static ItemCourseBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCourseBinding((CardView) rootView, tvDescription, tvDuration, tvName, tvStatus,
          tvTrainer, tvType);
    }
